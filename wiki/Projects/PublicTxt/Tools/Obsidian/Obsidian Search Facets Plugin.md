...
[Obsidian.md](Tools/Obsidian/Obsidian.md.md) Plugin for [PublicTxt](PublicTxt.md) Facet search - duplicating the search of [PublicTxt-Pages](../../PublicTxt-Pages.md)
...
Nothing here needs PublicTxt conventions. In a plain vault it is faceted search where type is the top-level folder and tags are Obsidian's tags. The plugin never writes to the vault.